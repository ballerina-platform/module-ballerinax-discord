...
public type KeywordRuleResponseActions BlockMessageActionResponse|FlagToChannelActionResponse|QuarantineUserActionResponse|UserCommunicationDisabledActionResponse;
...
public type MentionSpamRuleResponse record {
    ...
    # 
    MentionSpamRuleResponseActions[] actions;
    boolean? enabled?;
    @jsondata:Name {value: "trigger_metadata"}
...
public type MessageResponseComponents MessageComponentActionRowResponse|MessageComponentButtonResponse|MessageComponentChannelSelectResponse|MessageComponentInputTextResponse|MessageComponentMentionableSelectResponse|MessageComponentRoleSelectResponse|MessageComponentStringSelectResponse|MessageComponentUserSelectResponse;
...
public type MLSpamRuleResponse record {
    ...
    # 
    MLSpamRuleResponseActions[] actions;
    boolean? enabled?;
    @jsondata:Name {value: "trigger_metadata"}
...
public type GuildAuditLogResponse record {
    # 
    GuildAuditLogResponseWebhooks[] webhooks;
    # 
    ...
    GuildAuditLogResponseGuildScheduledEvents[] guildScheduledEvents;
    # 
    GuildAuditLogResponseIntegrations[] integrations;
    # 
    @jsondata:Name {value: "auto_moderation_rules"}
    GuildAuditLogResponseAutoModerationRules[] autoModerationRules;
    # 
    UserResponse[] users;
    # 
...
public type MLSpamRuleResponseActions BlockMessageActionResponse|FlagToChannelActionResponse|QuarantineUserActionResponse|UserCommunicationDisabledActionResponse;
...
public type InlineResponse2009 ApplicationIncomingWebhookResponse|ChannelFollowerWebhookResponse|GuildIncomingWebhookResponse;

public type InlineResponse2008 ApplicationIncomingWebhookResponse|ChannelFollowerWebhookResponse|GuildIncomingWebhookResponse;
...
public type InlineResponse2003 DefaultKeywordRuleResponse|KeywordRuleResponse|MLSpamRuleResponse|MentionSpamRuleResponse|SpamLinkRuleResponse;

public type InlineResponse2002 DefaultKeywordRuleResponse|KeywordRuleResponse|MLSpamRuleResponse|MentionSpamRuleResponse|SpamLinkRuleResponse;

public type InlineResponse2005 ExternalScheduledEventResponse|StageScheduledEventResponse|VoiceScheduledEventResponse;

public type InlineResponse2004 FriendInviteResponse|GroupDMInviteResponse|GuildInviteResponse;

public type InlineResponse2007 ExternalScheduledEventResponse|StageScheduledEventResponse|VoiceScheduledEventResponse;

public type InlineResponse2006 ExternalScheduledEventResponse|StageScheduledEventResponse|VoiceScheduledEventResponse;
...
public type GuildAuditLogResponseAutoModerationRules DefaultKeywordRuleResponse|KeywordRuleResponse|MLSpamRuleResponse|MentionSpamRuleResponse|SpamLinkRuleResponse;
...
public type GuildAuditLogResponseWebhooks ApplicationIncomingWebhookResponse|ChannelFollowerWebhookResponse|GuildIncomingWebhookResponse;
...
public type InlineResponse201 PrivateChannelResponse|PrivateGroupChannelResponse;
...
public type MessageResponse record {
    ...
    boolean mentionEveryone;
    # 
    MessageResponseComponents[] components;
    boolean pinned;
    # 
    MessageAttachmentResponse[] attachments;
    anydata activity?;
...
public type MentionSpamRuleResponseActions BlockMessageActionResponse|FlagToChannelActionResponse|QuarantineUserActionResponse|UserCommunicationDisabledActionResponse;
...
public type SpamLinkRuleResponse record {
    ...
    # 
    SpamLinkRuleResponseActions[] actions;
    boolean? enabled?;
    @jsondata:Name {value: "trigger_metadata"}
    record {} triggerMetadata;
};
...
public type KeywordRuleResponse record {
    ...
    # 
    KeywordRuleResponseActions[] actions;
    boolean? enabled?;
    @jsondata:Name {value: "trigger_metadata"}
...
public type GuildAuditLogResponseGuildScheduledEvents ExternalScheduledEventResponse|StageScheduledEventResponse|VoiceScheduledEventResponse;

public type SpamLinkRuleResponseActions BlockMessageActionResponse|FlagToChannelActionResponse|QuarantineUserActionResponse|UserCommunicationDisabledActionResponse;
...
public type InlineResponse20010 GuildStickerResponse|StandardStickerResponse;

public type InlineResponse20012 ApplicationIncomingWebhookResponse|ChannelFollowerWebhookResponse|GuildIncomingWebhookResponse;

public type '200OneOf6 anydata?;

public type InlineResponse20011 ApplicationIncomingWebhookResponse|ChannelFollowerWebhookResponse|GuildIncomingWebhookResponse;

public type InlineResponse20014 GuildChannelResponse|PrivateChannelResponse|PrivateGroupChannelResponse|ThreadResponse;

public type InlineResponse20013 GuildChannelResponse|PrivateChannelResponse|PrivateGroupChannelResponse|ThreadResponse;
...
public type InlineResponse20016 FriendInviteResponse|GroupDMInviteResponse|GuildInviteResponse;

public type InlineResponse20015 GuildChannelResponse|PrivateChannelResponse|PrivateGroupChannelResponse|ThreadResponse;
...
public type InlineResponse20017 FriendInviteResponse|GroupDMInviteResponse|GuildInviteResponse;
