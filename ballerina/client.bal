...
public isolated client class Client {
    ...
    resource isolated function patch guilds/[string guildId]/auto\-moderation/rules/[string ruleId](RulesruleIdBody payload, map<string|string[]> headers = {}) returns InlineResponse2002|error {
        string resourcePath = string `/guilds/${getEncodedUri(guildId)}/auto-moderation/rules/${getEncodedUri(ruleId)}`;
        map<anydata> headerValues = {...headers};
        if self.apiKeyConfig is ApiKeysConfig {
            headerValues["Authorization"] = self.apiKeyConfig?.authorization;
    ...
    resource isolated function post guilds/[string guildId]/auto\-moderation/rules(AutoModerationRulesBody payload, map<string|string[]> headers = {}) returns InlineResponse2003|error {
        string resourcePath = string `/guilds/${getEncodedUri(guildId)}/auto-moderation/rules`;
        map<anydata> headerValues = {...headers};
        if self.apiKeyConfig is ApiKeysConfig {
            headerValues["Authorization"] = self.apiKeyConfig?.authorization;
    ...
    resource isolated function put channels/[string channelId]/recipients/[string userId](ChannelsRecipientsRequest payload, map<string|string[]> headers = {}) returns InlineResponse201|error? {
    ...
    resource isolated function post channels/[string channelId]/invites(ChannelIdInvitesBody payload, map<string|string[]> headers = {}) returns InlineResponse2004|error? {
        string resourcePath = string `/channels/${getEncodedUri(channelId)}/invites`;
        map<anydata> headerValues = {...headers};
        if self.apiKeyConfig is ApiKeysConfig {
            headerValues["Authorization"] = self.apiKeyConfig?.authorization;
    ...
    resource isolated function get guilds/[string guildId]/scheduled\-events/[string guildScheduledEventId](map<string|string[]> headers = {}, *GetGuildScheduledEventQueries queries) returns InlineResponse2005|error {
    ...
    resource isolated function patch guilds/[string guildId]/scheduled\-events/[string guildScheduledEventId](ScheduledEventsguildScheduledEventIdBody payload, map<string|string[]> headers = {}) returns InlineResponse2006|error {
        string resourcePath = string `/guilds/${getEncodedUri(guildId)}/scheduled-events/${getEncodedUri(guildScheduledEventId)}`;
        map<anydata> headerValues = {...headers};
        if self.apiKeyConfig is ApiKeysConfig {
            headerValues["Authorization"] = self.apiKeyConfig?.authorization;
    ...
    resource isolated function post guilds/[string guildId]/scheduled\-events(GuildIdScheduledEventsBody payload, map<string|string[]> headers = {}) returns InlineResponse2007|error {
        string resourcePath = string `/guilds/${getEncodedUri(guildId)}/scheduled-events`;
        map<anydata> headerValues = {...headers};
        if self.apiKeyConfig is ApiKeysConfig {
            headerValues["Authorization"] = self.apiKeyConfig?.authorization;
    ...
    resource isolated function get webhooks/[string webhookId]/[string webhookToken](map<string|string[]> headers = {}) returns InlineResponse2008|error {
    ...
    resource isolated function patch webhooks/[string webhookId]/[string webhookToken](WebhooksRequest1 payload, map<string|string[]> headers = {}) returns InlineResponse2009|error {
        string resourcePath = string `/webhooks/${getEncodedUri(webhookId)}/${getEncodedUri(webhookToken)}`;
        map<anydata> headerValues = {...headers};
        if self.apiKeyConfig is ApiKeysConfig {
            headerValues["Authorization"] = self.apiKeyConfig?.authorization;
    ...
    resource isolated function get stickers/[string stickerId](map<string|string[]> headers = {}) returns InlineResponse20010|error {
    ...
    resource isolated function get webhooks/[string webhookId](map<string|string[]> headers = {}) returns InlineResponse20011|error {
    ...
    resource isolated function patch webhooks/[string webhookId](WebhooksRequest2 payload, map<string|string[]> headers = {}) returns InlineResponse20012|error {
        string resourcePath = string `/webhooks/${getEncodedUri(webhookId)}`;
        map<anydata> headerValues = {...headers};
        if self.apiKeyConfig is ApiKeysConfig {
            headerValues["Authorization"] = self.apiKeyConfig?.authorization;
    ...
    resource isolated function get channels/[string channelId](map<string|string[]> headers = {}) returns InlineResponse20013|error {
    ...
    resource isolated function delete channels/[string channelId](map<string|string[]> headers = {}) returns InlineResponse20014|error {
        string resourcePath = string `/channels/${getEncodedUri(channelId)}`;
        map<anydata> headerValues = {...headers};
        if self.apiKeyConfig is ApiKeysConfig {
            headerValues["Authorization"] = self.apiKeyConfig?.authorization;
    ...
    resource isolated function patch channels/[string channelId](ChannelschannelIdBody payload, map<string|string[]> headers = {}) returns InlineResponse20015|error {
        string resourcePath = string `/channels/${getEncodedUri(channelId)}`;
        map<anydata> headerValues = {...headers};
        if self.apiKeyConfig is ApiKeysConfig {
            headerValues["Authorization"] = self.apiKeyConfig?.authorization;
    ...
    resource isolated function get invites/[string code](map<string|string[]> headers = {}, *InviteResolveQueries queries) returns InlineResponse20016|error {
    ...
    resource isolated function delete invites/[string code](map<string|string[]> headers = {}) returns InlineResponse20017|error {
        string resourcePath = string `/invites/${getEncodedUri(code)}`;
        map<anydata> headerValues = {...headers};
        if self.apiKeyConfig is ApiKeysConfig {
            headerValues["Authorization"] = self.apiKeyConfig?.authorization;
